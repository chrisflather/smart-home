...
app.colors = {
    ...
    "brown": [150,75,0],
    "leather": [150,112,89],
    "purple mountains majesty": [150,120,182],
...
app.intent(
    'SetColor', 
    {
        ...
        "utterances": [
            "{|to} color {|the} {-|ROOM} {|light} {|to} {-|COLOR}",
            "{|to} color {|the} light {for|in|on} {|the} {-|ROOM} {|to} {-|COLOR}",
            "{|to} {set|change} {|the} color of {|the} {-|ROOM} {|light} to {-|COLOR}",
            "{|to} {set|change} {|the} color of {|the} light {for|in|on} {|the} {-|ROOM} to {-|COLOR}"
        ]
    },
    function(req,res) {
        var room = app.rooms[req.slot("ROOM")];
        var color = app.colors[req.slot("COLOR")];

        if (room == undefined) {
            res.say("sorry, i did not understand which light you meant");
            console.log("did not understand light; color " + req.slot("ROOM"));
            return;
        }

        if (color == undefined) {
            res.say("sorry, i did not understand which color you wanted");
            console.log("did not understand color; color " + req.slot("COLOR"));
            return;
        }
